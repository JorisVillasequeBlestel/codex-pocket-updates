# Codex Pocket Companion 0.4.4

- Synchronise automatiquement la conversation visible dans Codex Desktop après une réponse envoyée depuis l’iPhone.
- Utilise en priorité le même runtime Codex que l’application Mac pour éviter les divergences de version.
